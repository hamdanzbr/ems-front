      ...
      <tbody>
       {
        ...
        displayData.map((item,index)=>(
          ...
          <td><img style={{width:'80px',height:'80px',borderRadius:'50%'}} src={`${BASE_URL}/uploads/${item.profile}`} /></td>
          <td>
            <Link to={`/view/${item._id}`}> <i class="fa-solid fa-eye fs-3 me-2 text-light"></i></Link>
            <Link to={`/edit/${item._id}`}> <i class="fa-solid fa-pen fs-3 me-2 text-infot"></i></Link>
